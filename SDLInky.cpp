...
SDLInky::SDLInky(int rectX, int rectY, int rectW, int rectH, SDL_Renderer* gRenderer, SDL_Texture* spriteSheet, int posX, int posY):
	Inky(posX, posY), SDLGhost(rectX, rectY, rectW, rectH, gRenderer, spriteSheet){
